package com.netcracker.paladin.infrastructure;
...
public class ConfigUtility {
    ...
    public Properties loadProperties() throws IOException {
        ...
        defaultProps.setProperty("mail.user", "plzdontgay@gmail.com");
        defaultProps.setProperty("mail.password", "plzdontgay1");
